public class BossTank extends BubbleTank {
  ...
  public void buildBlocks() {
    ...
    if (type == 0) { // bull
      ...
      blocks.add(new BubbleBlock(350, 430 - 80, 40, getDirection(), color(82,54,27)));
      
      blocks.add(new BubbleBlock(350, 430 - 80, 20, getDirection(), color(175,28,25)));
    ...
    if (type == 1) {
      ...
      blocks.add(new BubbleBlock(350, 285, 60, getDirection(), color(255,231,0)));
      
      blocks.add(new BubbleBlock(350, 350, 75, getDirection(), color(255,103,0)));
      blocks.add(new BubbleBlock(395, 350, 35, getDirection(), color(255,141,0)));
      blocks.add(new BubbleBlock(305, 350, 35, getDirection(), color(255,141,0)));
      blocks.add(new BubbleBlock(375, 350, 35, getDirection(), color(255,193,0)));
      blocks.add(new BubbleBlock(325, 350, 35, getDirection(), color(255,193,0)));
      blocks.add(new BubbleBlock(350, 350, 25, getDirection(), color(255,231,0)));
    }
  }
